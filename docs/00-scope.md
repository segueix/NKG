...
## In scope (Phase 1)
- Single-file shell app (`index.html`) for pre-NKG project setup.
- Stage flow:
  1. idea
  2. premise
  3. structure
...
NKG is a project-foundation tool during Phase 1. It prepares inputs and structure; it does not write final novel manuscripts.
